...
<body>
	<div class="container">
		<h1>Electrician Form</h1>

		<form action="BookingControllerServlet" method="post">
			<input type="hidden" name="profession" value="electrician"> <label
			...
			<input type="submit" value="Book Electrician"> <input
